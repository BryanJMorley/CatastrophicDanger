...
{
	return FString::Printf(TEXT("Fuel: %f Heat: %f Moisture: %f State: %f Update: %s"), FData.fuel, FData.heat, FData.moisture, *UEnum::GetValueAsName(FData.fireState).ToString(), FData.update ? "true" : "false");
}
